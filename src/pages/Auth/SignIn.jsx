...
const SignIn = () => {
  ...
  return (
    <Box className="flex flex-col items-center mt-20 mx-auto w-1/2 max-w-sm">
      <h3 className="font-extrabold text-3xl text-red-600 my-4">Đăng nhập</h3>
      <span className="text-gray-500 font-semibold mb-2 ">
        Vui lòng nhập chi tiết đăng nhập của bạn để có quyền truy cập
      </span>
      <form className="w-full mt-8" onSubmit={handleSubmit(onLoginSubmit)}>
        ...
        <Button
          variant="contained"
          className="py-3 text-xs w-full font-bold mt-4"
          text="Đăng nhập"
        />
      </form>
    </Box>
